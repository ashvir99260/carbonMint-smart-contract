...
export const MetaMaskProvider = ({ children }) => {
  ...
  useEffect(() => {
    if (library) {
      console.log("🚀 ~ file: metamask.js:24 ~ useEffect ~ library", library);

      library?.eth
        ?.getTransaction("0x1f099D1cc110844C1c0f2B3008251CC60455B599")
        .then((result) => {
          console.log(
            "🚀 ~ file: metamask.js:24 ~ useEffect ~ getBalance",
            result
          );
        });
